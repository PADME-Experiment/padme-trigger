...
proc create_root_design { parentCell } {
  ...
  set FCLK_CLK1_MHZ [ create_bd_port -dir O -type clk FCLK_CLK1_MHZ ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {1.016260} \
   ...
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {41} \
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR1 {24} \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {1.016} \
  ...
  connect_bd_net -net M_AXI_GP0_ACLK_0_1 [get_bd_ports ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_1M/slowest_sync_clk]
  connect_bd_net -net dcm_locked_0_1 [get_bd_ports LOCKED] [get_bd_pins rst_ps7_0_1M/dcm_locked]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK1_MHZ] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net rst_ps7_0_1M_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_ps7_0_1M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_1M_peripheral_aresetn1 [get_bd_ports aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_ps7_0_1M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_1M_peripheral_reset [get_bd_ports RST] [get_bd_pins rst_ps7_0_1M/peripheral_reset]
